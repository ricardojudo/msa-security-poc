...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader
                .getResource("classpath:/security/wso2carbon.jks");
	...
	public ExtendedMetadataDelegate ssoCircleExtendedMetadataProvider()
		...
		Resource resource = resourceLoader.getResource("classpath:/security/wso2-ids.xml");
		
		File file = File.createTempFile("wso2-ids.xml", UUID.randomUUID().toString());
		
		FileOutputStream fos = new FileOutputStream(file);
		IOUtils.copy(resource.getInputStream(), fos);		
		FilesystemMetadataProvider metadataProvider = new FilesystemMetadataProvider(file);
...
//        metadataGenerator.setEntityId("com:vdenotaris:spring:sp");
        metadataGenerator.setEntityId("demo-sp");
        metadataGenerator.setExtendedMetadata(extendedMetadata());
        metadataGenerator.setIncludeDiscoveryExtension(false);
        metadataGenerator.setKeyManager(keyManager()); 
        metadataGenerator.setEntityBaseURL("http://demo-sp:8080");
